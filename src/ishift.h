TYPE* APIprefix(ishift_1d)(const TYPE *in, size_t Nx)
{
	if ( in == NULL || Nx < 2 ) return NULL;

	TYPE *out = malloc( Nx * sizeof(TYPE) );
	APIprefix(ishiftExt_1d)(out,in,Nx);
	return out;
}


void APIprefix(ishiftIn_1d)(TYPE *A, size_t Nx)
{
...
void APIprefix(ishiftExt_1d)(TYPE *restrict out, const TYPE *restrict in, size_t Nx)
{
